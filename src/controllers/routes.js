// Imports (Core-Middleware-SubRouters-Routes)
...
import builderSubRouter from "./builderRoutes.js";
...
// Mount sub-routers
router.use("/builder", builderSubRouter);
...
router.get("/notes/new", requireLogin, showCreateNoteForm);
router.get("/notes/manage", requireLogin, showNoteManager);
router.get("/notes/:id/edit", requireLogin, showEditNoteForm);
...
// Routes.post that requireRole (gm_admin)
