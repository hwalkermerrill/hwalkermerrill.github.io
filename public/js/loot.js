...
const loot = [
  {
    ...
    img: true,
    src: "/images/objects/loot-cocoon-cloak.webp",
    description: [
  ...
  },
  {
    ...
    img: true,
    src: "/images/objects/loot-zenj-spirit-fetish.webp",
    description: [
  ...
  },
  {
    ...
    img: true,
    src: "/images/objects/loot-war-mask-terror.webp",
    description: [
    ...
    if (item.img === true) {
      lootElement.innerHTML += `
        ...
        <picture>
          ...
          <img class="pointer tooTall" src="/images/core/unknown.png" alt="${item.name}" loading="lazy">
        </picture>
        </li>
      `;
    }
