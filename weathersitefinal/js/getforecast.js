function futureWeather(x) {
    ...
    weatherObject.open('GET','//api.openweathermap.org/data/2.5/forecast?id=' + cid + '&appid=fb75400a87c1c698878761e1d3548782&units=imperial',true);
    weatherObject.send();
    weatherObject.onload = function pullForecast() {
