...
function showJSON(jsonObj,divClass) {
  ...
  // Create Loop that Builds Articles from JSON Data
  for (var i = 0; i < localJObj.length; i++) {
    ...
    // Create Unsorted List (ul)
    var listSocial = document.createElement('li');
    listSocial.textContent = 'Discovery Skills: ' + localJObj[i].socialblock;
    myList1.appendChild(listSocial);
